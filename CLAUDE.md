...
- `AA_CLEANUP_MODEL` (optional, default `claude-opus-4-8`, also `-cleanup-model`) — model for the final cleanup pass (web + PDF). The agent loop and summaries use the regular `-model` (default Sonnet 4.6).
